...
describe('MCP Connection Tests', () => {
    ...
    test('should fail fast on invalid server config', () => {
        ...
        expect(() => invalidValidator.registerHandlers()).toThrow('Contract violation: Server must be created before registering handlers');
    });
});
//# sourceMappingURL=mcp-connection.jest.test.js.map