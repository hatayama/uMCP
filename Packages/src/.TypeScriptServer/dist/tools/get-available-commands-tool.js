    ...
    async execute(args) {
        try {
            ...
            commandDetails.forEach((cmd, index) => {
                ...
                if (schema && schema[PARAMETER_SCHEMA.PROPERTIES_PROPERTY] && Object.keys(schema[PARAMETER_SCHEMA.PROPERTIES_PROPERTY]).length > 0) {
                    responseText += `   Parameters:\n`;
                    Object.entries(schema[PARAMETER_SCHEMA.PROPERTIES_PROPERTY]).forEach(([paramName, paramInfo]) => {
                        ...
                        if (paramInfo[PARAMETER_SCHEMA.ENUM_PROPERTY] && paramInfo[PARAMETER_SCHEMA.ENUM_PROPERTY].length > 0) {
...
//# sourceMappingURL=get-available-commands-tool.js.map