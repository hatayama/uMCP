...
namespace io.github.hatayama.uMCP
{
    ...
    public static class UnityApiHandler
    {
        ...
        public static async Task<object> ExecuteCommandAsync(string commandName, JToken paramsToken, CancellationToken cancellationToken = default)
        {
            return await commandRegistry.ExecuteCommandAsync(commandName, paramsToken, cancellationToken);
        }
    }
} 